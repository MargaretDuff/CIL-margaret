...
class TotalVariationNew(Function):
    ...
    def _fista_on_dual_rof(self, x, tau, out = None):
        ...
        p1 = self.gradient.range_geometry().allocate(0) #  dual variable - is overwritten during iterations 
        ...
        should_break = False
        for k in range(self.iterations): # line 3 
            ...
            p1.multiply(multip,out=p1) #line 4/5 p1=gk?
            ...
            self.func.proximal_conjugate(tmp_q, 1.0, out=p1) #- projection_U , p1=pk
